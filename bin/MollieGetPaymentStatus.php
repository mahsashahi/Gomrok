...
/**
 * Look up a Mollie payment's status.
 *
 *   php bin/MollieGetPaymentStatus.php --client=televika --account=mollie-live --reference=tr_...
 */
...
if ($opts === false || !isset($opts['client'], $opts['account'], $opts['reference'])) {
    fwrite(STDERR, "usage: php bin/MollieGetPaymentStatus.php --client=<slug|id> --account=<account-slug> --reference=<payment-id>\n");
    exit(2);
}
