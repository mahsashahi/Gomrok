...
| File | What it is |
| --- | --- |
| `GomrokAdminPanelV4.dc.html` | **Current design.** Canvas source (`<x-dc>` template + `{{ }}` bindings). |
| `GomrokAdminPanelV4Export.dc.html` | v4 with an embedded thumbnail `<template>` — same UI as v4. |
| `GomrokAdminPanelV3.dc.html` | Earlier iteration. |
| `GomrokAdminPanelV2.dc.html` | Earlier iteration. |
| `GomrokAdminPanel.dc.html` | First iteration. |
