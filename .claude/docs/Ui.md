...
- `Design/` (project root) — the mirrored Claude Design admin-panel mockups (`Design/Readme.md`);
  the current design is `Design/GomrokAdminPanelV4.dc.html`.
...
- Spacing / colour / type tokens extracted from the `Design/` files.
