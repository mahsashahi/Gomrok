...
| `bin/{CreateCheckoutAttempt,ResolveCheckoutPricing,ReserveCheckoutVoucher,SelectCheckoutProvider,SetCheckoutAttemptStatus,ListCheckoutAttempts}.php` | Checkout attempt CLI (`composer checkout:create\|resolve-pricing\|reserve-voucher\|select-provider\|set-status\|list-attempts`) — Phase 18. |
